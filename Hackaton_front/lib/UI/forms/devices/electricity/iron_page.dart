...
import 'package:hackaton_front/Models/iron.dart';
                        ...
                        Row(
                         ...
                         Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.iron, size: 150, color: Colors.white),
                                
                                    Padding(
                                      padding: const EdgeInsets.all(30),
                                      child: Text(objekat == null ? "Choose iron device": objekat!.naziv,
                                ...
                                Padding(
                                          padding: const EdgeInsets.all(30),
                                          child: Text(objekat == null ? "First choose device" : objekat!.stanjeStruje == true ? "Iron is ON" : "Iron is OFF",
                                          style: const TextStyle(color: Colors.white, fontSize: 15)),
              ...
              onTap: () {
                          ...
                          objekat = snapshot.data![index];
                            ...
                            Navigator.of(context).pushReplacement(
                                      MaterialPageRoute(
                                        builder: (context) => IronPage(selectedIndex, objekat),
                                      ),
                                    );
                          });
                        },
...
Future<List<Iron>> fetch() async{
  var data = RoleUtil.getData();
  var url = Uri.parse('${GlobalUrl.url}Pegla/GetByHouse?homeId=${data["kucaId"]}');
