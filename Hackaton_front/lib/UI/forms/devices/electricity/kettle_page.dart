...
import 'package:hackaton_front/Models/kettle.dart';
                    ...
                    child: Column(
                      ...
                      Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.soup_kitchen, size: 150, color: Colors.white),
                                
                                    Padding(
                                      padding: const EdgeInsets.all(30),
                                      child: Text(objekat == null ? "Choose kettle": objekat!.naziv,
                                ...
                                Padding(
                                          padding: const EdgeInsets.all(30),
                                          child: Text(objekat == null ? "First choose kettle" : objekat!.stanjeStruje == true ? "Kettle is ON" : "Kettle is OFF",
                                          style: const TextStyle(color: Colors.white, fontSize: 15)),
              ...
              onTap: () {
                          ...
                          objekat = snapshot.data![index];
                            ...
                            Navigator.of(context).pushReplacement(
                                      MaterialPageRoute(
                                        builder: (context) => KettlePage(selectedIndex, objekat),
                                      ),
                                    );
                          });
                        },
...
Future<List<Kettle>> fetch() async{
  var data = RoleUtil.getData();
  var url = Uri.parse('${GlobalUrl.url}Kuhalo/GetByHouse?homeId=${data["kucaId"]}');
